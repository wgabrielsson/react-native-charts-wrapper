...
export const axisIface = {
  ...
  valueFormatter: PropTypes.oneOfType([
    PropTypes.oneOf(['largeValue', 'percent', 'date', 'hour', 'unit']),
    PropTypes.string,
    PropTypes.arrayOf(PropTypes.string)
  ]),
  valueFormatterPattern: PropTypes.string,
  valueFormatterMax: PropTypes.number, //Axis labels will be empty for values above
  valueFormatterMin: PropTypes.number,//Axis labels will be empty for values below
  unitSuffix: PropTypes.string,//Suffix to be used when value formatter is of type unit
